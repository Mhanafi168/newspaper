          ...
          {mode === 'register' && (
            <div className="field">
              ...
              <select name="role" value={form.role} onChange={handle}>
                ...
                <option value="editor">Editor — write and publish</option>
              </select>
            </div>
          )}
